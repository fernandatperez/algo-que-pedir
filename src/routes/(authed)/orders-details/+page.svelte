...
<main class="container-column">
    <div class="container-column main-content">
        <div class="w-100 flex-row jc-space-between header-container text-wrapper">
            ...
            <div class="flex-row gap-1 order-state-title">
                <h2 class="subtitle ellipsis-text">Estado del Pedido</h2>
                <button class="btn btn-alternate">Pendiente</button>
            </div>
        </div>
        ...
        <section>
            ...
            <div class="user">
                ...
                <div class="user-info">
                    ...
                    <div class="username"><strong>usuario:</strong> smiller2006</div>
                </div>
            </div>
        </section>
        <section>
            ...
            <address class="address-container">
                ...
                <div>
                    <div class="address"><strong>Av siempre viva 555</strong></div>
    ...
    <section class="content-section-grid grid">
            ...
            <div class="grid-table-container product-edit-ingredients-table">
                ...
                <section class="grid-table-row product-edit-ingredients-table-content">
                    ...
                    <div class="imgcontainer"><img src="/assets/img/hamburguesa.png" alt="hamburguesa" class="hide-on-mobile"></div>
                        <div class="text-wrapper">
                        <h4 class="ellipsis-text h4">Hamburguesa con queso</h4>
                        <p class="hide-on-mobile ellipsis-text">Hamburguesa con queso acompañada de papas fritas y bebida</p>    
                        </div>
                    </div>
                    <div class="cell">
                        1
                ...
                <section class="grid-table-row product-edit-ingredients-table-content">
                    ...
                    <div class="imgcontainer"><img src="/assets/img/pizza.png" alt="pizza" class="hide-on-mobile"></div>
                        <div class="text-wrapper">
                        <h4 class="ellipsis-text h4" >Pizza</h4>
                        <p class="hide-on-mobile ellipsis-text">De muzzarella con tomate y albahaca</p>    
                        </div>
                    </div>
                    <div class="cell">
                        1
                ...
                <section class="grid-table-row product-edit-ingredients-table-content">
                    <div class="cell product-cell ellipsis-text">
                    <div class="imgcontainer"><img src="/assets/img/ensalada.png" alt="ensalada" class="hide-on-mobile"></div>
                        <div class="text-wrapper">
                        <h4 class="ellipsis-text h4">Ensalada</h4>
                        <p class="hide-on-mobile ellipsis-text">De hojas frescas y vegetales organicos</p>    
                        </div>
                    </div>
                    <div class="cell">
                        1
